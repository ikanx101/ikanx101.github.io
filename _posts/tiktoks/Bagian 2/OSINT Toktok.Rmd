...
analisa %>% 
  ...
  theme_minimal() +
  labs(title = "Timeline Penambahan Post #SetinggiLangit",
       subtitle = "303 post di TikTok dengan hashtag #SetinggiLangit",
...
analisa %>% 
  ...
  theme_minimal() +
  labs(title = "Timeline Penambahan Cumulative Followers dari Para User yang Post #SetinggiLangit",
       subtitle = "303 post di TikTok dengan hashtag #SetinggiLangit",
       x = "Timeline sejak post pertama (dalam menit)",
