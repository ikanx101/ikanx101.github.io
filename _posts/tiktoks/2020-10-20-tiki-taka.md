...
*T*kT*k page source* untuk mengambil data yang saya mau. Nah, kali ini
saya akan mengambil data terkait *hashtag* **\#SetinggiBintang** di
*T*kT*k*. Semua data ini saya *scrape* per tanggal `20 Oktober 2020`
pukul `10:50` WIB *yah*.
...
**T*kT*k** memang membatasi video yang di-*post* oleh *user*-nya. Untuk
...
Dari sekian banyak *user* **T*kT*k** yang posting **\#SetinggiBintang**,
saya penasaran… Siapa yang memiliki *follower* terbanyak? Siapa yang
paling **produktif**? (memiliki video terbanyak di **T*kT*k**).
