---
title: "Ngoprek #SetinggiBintang di T*kT*k"
output: 
  github_document:
    pandoc_args: --webtex
---
...
Oke, kembali ke topik. Saya akan menggunakan kombinasi antara __R__ dan _T*kT*k page source_ untuk mengambil data yang saya mau. Nah, kali ini saya akan mengambil data terkait _hashtag_ __#SetinggiBintang__ di _T*kT*k_. Semua data ini saya _scrape_ per tanggal `20 Oktober 2020` pukul `10:50` WIB _yah_. 
...
Tapi kalau isi komen dan siapa yang komen, saya harus mengambilnya dari _page source_ si __T*kT*k__-nya.
...
__T*kT*k__ memang membatasi video yang di-_post_ oleh _user_-nya. Untuk _hashtag_ __#SetinggiBintang__ ada dua kelompok video berdasarkan durasinya. Sebagian besar berada di kisaran `15` detik, selainnya ada di `19` detik.
...
hestek_setinggi_bintang %>% 
  ...
  labs(title = "Sebaran Durasi Video",
       subtitle = "303 Video T*kT*k #SetinggiBintang",
...
pilter %>% 
  ...
  geom_text(aes(label=label),
            position = "jitter") +
  theme_minimal() +
  labs(title = "Likes vs Comments Video T*kT*k",
       subtitle = "303 Video T*kT*k #SetinggiBintang",
       caption = "Scraped and Visualized\nusing R\nikanx101.com",
       x = "Banyak likes",
       y = "Banyak comments")
...
Dari sekian banyak _user_ __T*kT*k__ yang posting __#SetinggiBintang__, saya penasaran... Siapa yang memiliki _follower_ terbanyak? Siapa yang paling __produktif__? (memiliki video terbanyak di __T*kT*k__).
...
hestek_setinggi_bintang %>% 
  ...
  theme_minimal() +
  labs(title = "Siapa yang Memiliki Follower dan Video Terbanyak di T*kT*k?",
       subtitle = "303 Video T*kT*k #SetinggiBintang",
       caption = "Scraped and Visualized\nusing R\nikanx101.com",
       x = "Banyak follower",
       y = "Banyak Video")
