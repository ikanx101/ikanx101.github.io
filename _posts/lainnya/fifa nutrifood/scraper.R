...
# informasi dan data terkait top goalscorer
url = "https://en.wikipedia.org/wiki/FIFA_World_Cup_top_goalscorers"
df_goal_scorer = url %>% read_html() %>% html_table(fill = T)
df_top_goal = df_goal_scorer[[3]]
