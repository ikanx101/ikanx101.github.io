...
__Pertama__ Maksimum jam kerja harian adalah 7 jam saja.

$$\forall i, \forall j \sum_{k} x_{ijk} \times t_k \leq 7$$

__Kedua__ Setiap _request_ yang muncul hanya boleh dikerjakan oleh satu orang _team member_ saja.
