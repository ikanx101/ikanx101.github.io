...
Sekarang mari kita lihat __hantaman__ Covid 19 per negara seperti yang saya himpun dari situs `r url` per `r waktu_scrape`. Berikut adalah data yang saya akan gunakan:

```{r,echo=FALSE}
cat("Contoh 10 Data Teratas")
clean_data %>% head(10) %>% knitr::kable()
cat("Contoh 10 Data Terbawah")
clean_data %>% tail(10) %>% knitr::kable()
```
