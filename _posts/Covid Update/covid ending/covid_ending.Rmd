...
top_3 = clean_data %>% arrange(desc(ratio_sakit)) %>% head(3)
top_3 = top_3$country_other
...
Mayoritas negara-negara di dunia memiliki _ratio infected person_ __< 10%__. Ada hal yang menarik menurut saya: China sebagai negara _suspect_ bagi _patient zero_ ternyata "hanya" memiliki _ratio infected person_ sebesar __0.1%__ saja. Berikut adalah 3 negara yang memiliki _ratio infected person_ terbesar:
