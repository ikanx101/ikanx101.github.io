...
target = c("Indonesia","Italy","Malaysia","Singapore","China")
...
Berbekal data yang dihimpun di situs [_Our World in Data_](https://ourworldindata.org/coronavirus) per pagi ini (11 September 2020 pukul 09.00), saya akan coba membandingkan data negara kita dengan data negara lainnya seperti: `Italy`, `Singapura`, `Malaysia`, dan `China`.
