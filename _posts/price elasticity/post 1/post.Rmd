...
data %>% 
  ...
  ggplot(aes(x = bulan,
             y = value)) +
  geom_line(group = 1) +
  geom_label(aes(label = value),size = 1,5) +
...
Tapi setelah melihat harga yang ditawarkan oleh kompetitor langsung minyak goreng `XYZ`, ternyata kompetitor juga menaikkan harganya pada Q4.
