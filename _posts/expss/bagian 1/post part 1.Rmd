...
```{r}
knitr::kable("https://raw.githubusercontent.com/ikanx101/ikanx101.github.io/master/_posts/expss/bagian%201/Screenshot_20201023-101029.png")
```
...
> Prinsipnya adalah satu responden disimpan dalam satu baris data. To
