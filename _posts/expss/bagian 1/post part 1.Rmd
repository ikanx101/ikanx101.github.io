...
Sekarang saya akan menggunakan contoh data hasil survey mengenai kebiasaan belanja. Survey dilakukan kepada `1.000` orang responden di 5 kota (Jakarta, Bandung, Tasikmalaya, Garut, dan Sukabumi). Sebagai latihan bersama, data bisa diunduh di sini.
