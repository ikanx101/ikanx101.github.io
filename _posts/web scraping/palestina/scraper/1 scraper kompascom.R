...
# home url
home_url = "https://indeks.kompas.com/?source=navbar&site=news&page="
...
scrape_detikcom = function(url_input){
  ...
  judul = 
    ...
    stringr::str_trim()
  # gabungin data
  df = data.frame(judul,links) %>% filter(judul != "")
  return(df)
}
...
save(temp_df,file = "kompascom.rda")
