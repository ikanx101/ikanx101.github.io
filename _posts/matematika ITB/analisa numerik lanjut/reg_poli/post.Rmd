...
Misalkan saya memiliki $n$ buah pasang data sebagai berikut: $(x,y)$, lalu kita hendak membuat persamaan regresi berikut ini: $f(x) = y = a_0 + a_1 x + a_2 x^2 + a_3 x^3 + .. + a_n x^n$.
...
Misalkan saya memiliki $n$ buah data dengan $m$ banyak pangkat polinom. Maka ekspektasi kita adalah:
