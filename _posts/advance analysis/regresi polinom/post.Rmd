...
__Titik belok__ bisa didapatkan dengan cara mencari turunan kedua $\frac{d}{dx^2}f(x)$. Suatu titik $a$ disebut titik belok saat $f(a)$ ter-diferensiabel dua kali, $\frac{d}{dx^2}f(a) = 0$, dan memenuhi:

- Untuk $x < a$, didapatkan $\frac{d}{dx^2}f(x) > 0$.
- Untuk $x > a$, didapatkan $\frac{d}{dx^2}f(x) < 0$.
...
contoh %>% 
  ...
  labs(title = "Contoh Kurva Persamaan Kuadrat Orde 3",
       ...
       caption = "Contoh ilustrasi titik early signal\nPerhatikan kurva di sebelah kiri (0,0) yanag terbuka ke atas.") +
  theme(plot.title = element_text(hjust = .5,
                                  face = "bold",
                                  size = 15),
        plot.subtitle = element_text(hjust = .5),
