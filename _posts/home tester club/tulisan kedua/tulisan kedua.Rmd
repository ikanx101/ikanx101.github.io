...
setwd("~/Documents/ikanx101/_posts/home tester club/tulisan kedua")
library(dplyr)
library(tidytext)
library(tidyr)
library(ggplot2)
...
Untuk membuktikannya, saya akan lakukan analisa _bi-grams_ dari semua pasangan kata yang mengandung kata `tidak` dan persamaan katanya.
